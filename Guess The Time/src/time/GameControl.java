...
public class GameControl {
	...
	// used to control the length of the game and when to naturally quite the timer thread
	...
	public static void main(String[] args) {
		...
		System.out.println("Hit any key end enter when you think time is up");
		...
		if (thread.isAlive()) {
			...
			System.out.println("Way too late! Your missed the target by at least double");
			thread.interrupt();
		}
